...
public class ShipControl : NetworkBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.DrawTexture(new Rect(pos.x - 26, Screen.height - pos.y + 20, 52, 7), boxTexture);

        // draw health bar amount
        GUI.color = Color.green;
        GUI.DrawTexture(new Rect(pos.x - 25, Screen.height - pos.y + 21, health / 2, 5), boxTexture);

        // draw energy bar background
        GUI.color = Color.grey;
        GUI.DrawTexture(new Rect(pos.x - 26, Screen.height - pos.y + 27, 52, 7), boxTexture);

        // draw energy bar amount
        GUI.color = Color.magenta;
        GUI.DrawTexture(new Rect(pos.x - 25, Screen.height - pos.y + 28, energy / 2, 5), boxTexture);
    }
